package org.jze.common.mybatis.handler;
...
import org.jze.common.core.domain.dto.RoleDTO;
import org.jze.common.core.domain.model.LoginUser;
import org.jze.common.core.exception.ServiceException;
import org.jze.common.core.utils.SpringUtils;
import org.jze.common.core.utils.StreamUtils;
import org.jze.common.core.utils.StringUtils;
import org.jze.common.mybatis.annotation.DataColumn;
import org.jze.common.mybatis.annotation.DataPermission;
import org.jze.common.mybatis.enums.DataScopeType;
import org.jze.common.mybatis.helper.DataPermissionHelper;
import org.jze.common.satoken.utils.LoginHelper;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (ignoreMap.containsKey(dataColumn)) {
                    // 修复多角色与权限标识符共用问题 https://gitee.com/dromara/Jze/issues/IB4CS4
